package computerscience.java.tick1; 


public class PackedLong2 {
/*
...
long packedset = packed;

if (value) { packedset = (packed | (1<<position)) ;} else {packedset =  ((1 << position) ^ 0xffffffffffffffffL) & packed ;}
